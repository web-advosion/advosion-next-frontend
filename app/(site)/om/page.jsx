...
export default async function Page() {
  ...
  return (
    <main className="w-screen h-auto overflow-hidden flex flex-col items-center">
      ...
      <section
        id="hero"
        className="margin-to-nav w-screen h-auto px-7.5 md:px-10.75 lg:px-48 xl:px-150 2xl:px-100 bg-(--primary-bg) mb-12.5 lg:mb-20 relative margin-to-nav-mobile "
      >
            ...
            <div className="mt-5 lg:flex lg:items-start">
              <div className=" w-full h-auto md:w-[90%]">
                <p>
                  ...
                  <strong>samlet under ét tag</strong> og synergien mellem de to
                  forretningsområder betyder, at vi udvikler endnu bedre
                  løsninger til gavn for dig og din virksomhed. Vi er eksperter
                  i at rådgive i krydsfeltet mellem økonomi og jura. Hurtigt og
                  enkelt, og uden fordyrrende mellemled.
                </p>
              </div>
            </div>
          </div>
