...
export default async function Page() {
  ...
  return (
    <main className="w-screen h-auto overflow-hidden flex flex-col items-center">
        ...
        <div className="mx-auto w-full max-w-6xl 2xl:max-w-350 px-6.5 lg:px-3.5">
          <div className="md:flex justify-between">
            <article className="md:w-3/4 lg:w-2/3">
              <div className="justify-start text-(--primary-bg) text-3xl md:text-4xl font-bold font-['Inter'] flex items-end gap-3 leading-7">
            ...
            <article className="w-32 h-32 mt-12.5">
              <ButtonPDF
                documentPath={documentUrls.betingelser}
                imageURL="/img/icon-pdf-white.svg"
              />
            </article>
          </div>
        </div>
      ...
      <section
        id="privat"
        className=" w-screen h-auto  bg-(--primary-bg) py-20 relative scroll-mt-12.5"
      >
        <div className="mx-auto w-full max-w-6xl 2xl:max-w-350 px-6.5 lg:px-3.5">
          <div className="md:flex justify-between">
            <article className="md: w-3/4 lg:w-2/3">
      ...
      >
        <div className="mx-auto w-full max-w-6xl 2xl:max-w-350 px-6.5 lg:px-3.5">
          <div className="md:flex justify-between">
            <article>
              <div className="w-max justify-start text-(--primary-bg) text-4xl font-bold font-['Inter'] leading-7">
                <h2>Bankoplysninger</h2>
              </div>

              <div className="lg:flex lg:justify-between">
                <div
                  className="mt-5 w-full md:max-w-[80%] lg:max-w-2/3 h-auto text-(--primary-bg)"
                  data-aos="fade-in"
                >
                  <p>
                    ...
                    <br /> <br />
                    ADVOSION STATSAUT. REVISORPARTNERSELSKAB CVR nr: 37 55 70 64
                  </p>
                </div>
              </div>
            </article>
