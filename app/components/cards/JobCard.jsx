...
export default function JobCard({ jobopslag, bgColor, textColor }) {
  return (
    <Link href="#">
      <div className="min-w-64 h-125 bg-(--revision-blue) text-(--primary-bg) rounded-2xl shadow-md flex flex-col p-4">
