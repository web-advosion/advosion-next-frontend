...
export default function AndetEmployeeCard({ medarbejder }) {
  ...
  return (
    <div className="min-w-64 max-w-64 h-auto bg-(--cta-black) rounded-2xl shadow-md flex flex-col overflow-hidden">
      {/* Billede */}
      <div>
        <Image
      ...
      <div className="flex flex-col flex-1 mt-3 gap-5 text-(--primary-bg) p-4">
        <div>
